...
function respawnInvocation(launch: Launch): { file: string; args: string[]; viaShell: boolean; detached: boolean } {
...
export function scheduleDshRestart(): RestartResult {
