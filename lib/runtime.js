...
let AgentSkillsRuntime = (() => {
    ...
    let _takeoverStatus_decorators;
    let _enableTakeover_decorators;
    let _disableTakeover_decorators;
    let _restartDsh_decorators;
    ...
    return class AgentSkillsRuntime extends _classSuper {
        static {
            ...
            _takeoverStatus_decorators = [Remote];
            _enableTakeover_decorators = [Remote];
            _disableTakeover_decorators = [Remote];
            _restartDsh_decorators = [Remote];
            ...
            __esDecorate(this, null, _takeoverStatus_decorators, { kind: "method", name: "takeoverStatus", static: false, private: false, access: { has: obj => "takeoverStatus" in obj, get: obj => obj.takeoverStatus }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _enableTakeover_decorators, { kind: "method", name: "enableTakeover", static: false, private: false, access: { has: obj => "enableTakeover" in obj, get: obj => obj.enableTakeover }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _disableTakeover_decorators, { kind: "method", name: "disableTakeover", static: false, private: false, access: { has: obj => "disableTakeover" in obj, get: obj => obj.disableTakeover }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _restartDsh_decorators, { kind: "method", name: "restartDsh", static: false, private: false, access: { has: obj => "restartDsh" in obj, get: obj => obj.restartDsh }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        async enableTakeover() {
            return { ...enablePresetTakeover(), boot: BOOT_ID };
        }
        /** Restore the official filesystem provider in the shipped presets. */
        async disableTakeover() {
            return { ...disablePresetTakeover(), boot: BOOT_ID };
        }
        /** Restart the current DSH web host so a preset provider change is mounted. */
        async restartDsh() {
            if (restartScheduled)
                throw new Error("DSH 重启已在进行中");
            restartScheduled = true;
            try {
                const result = scheduleDshRestart();
                // Safety valve: a failed replacement must not wedge the button forever.
                // The window outlasts the client's 60s poll deadline; a healthy restart
                // replaces this process (and its flag) long before it fires.
