import { addDirInputSchema, agentSkillsViewSchema, presetTakeoverStatusSchema, restartResultSchema, removeDirInputSchema, toggleDirInputSchema, toggleSkillInputSchema } from "./schemas.js";
        ...
        services: [
            {
                ...
                types: [
                    ...
                    },
                    {
                        ...
                        declaration: "export interface PresetTakeoverStatus { available: boolean; enabled: boolean; configured: number; total: number; boot?: string; }"
                    },
                    {
                        name: "RestartResult",
